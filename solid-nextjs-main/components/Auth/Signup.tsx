...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log(data.first_name, data.last_name, data.email, data.password, data.phone, data.city);
      ...
      if (err.response) {
        ...
        setError(err.response.data.detail || 'An error occurred while creating your account.');
